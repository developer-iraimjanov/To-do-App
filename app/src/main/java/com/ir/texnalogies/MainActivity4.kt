...
import com.ir.texnalogies.Adapter.DegreeAdapter
...
class MainActivity4 : AppCompatActivity() {
    ...
    private fun SavearrayListData() {
        ...
        if (boolean){
            arrayListData.add(ForUserData("Open" , name , description , degree , createData , deadline))
            ...
            Toast.makeText(this, "The plan with this name is already available, please try again by renaming the plan", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun CollectionDegreeList() {
        ...
        spinner_degree.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(
                ...
                Object.forDegree = arrayList[position].string.toString()
            }
